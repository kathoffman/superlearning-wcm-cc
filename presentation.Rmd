...
- A common variation of bagging is a **Random Forest**, where **slightly different decision trees** are fit to bootstrapped data
  ...
  - Different because *hyperparameters* such as maximum number of predictors, number of branches, depth of branches, or minimum number of observations in each leaf are **intentionally varied**
...
- Similarly to bagging, we want to compile weak models. Two main ways to do this:
...
- When van der Laan et. al proved the theoretical properties, referred to the algorithm as "superlearning," which gained popularity in statistics literature, while "stacking" is frequently used in the larger data science/machine learning community
...
- Can be any parametric or non-parametric statistical learning algorithm
